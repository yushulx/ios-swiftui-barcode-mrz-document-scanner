...
class MRZResultViewController: UIViewController {
    ...
    func analyzeData() {
        resultListArray = [
            ["Title": "Document Type", "Content": mrzResultModel.documentType],
            ...
            [
                "Title": "Age:",
                "Content": mrzResultModel.age != -1
                    ? String(format: "%ld", mrzResultModel.age) : "Unknown",
            ],
    ...
    func setupUI(in contentView: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            dismissButton.trailingAnchor.constraint(
                equalTo: contentView.trailingAnchor, constant: -20),  // 20 points from the right
        ])
    }
